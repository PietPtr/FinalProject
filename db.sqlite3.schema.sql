BEGIN TRANSACTION;
CREATE TABLE "restaurant_variables" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "key" varchar(1024) NOT NULL, "value" varchar(1024) NOT NULL);
CREATE TABLE "restaurant_order" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "done" smallint NOT NULL, "account_id" integer NULL REFERENCES "restaurant_account" ("id"), "food_id" integer NOT NULL REFERENCES "restaurant_food" ("id"), "chrono" datetime NOT NULL);
...
CREATE TABLE "restaurant_cardswipe" ("device" varchar(50) NOT NULL, "card_id" integer NOT NULL REFERENCES "restaurant_card" ("id"), "identifier" integer NOT NULL PRIMARY KEY AUTOINCREMENT);
CREATE TABLE "restaurant_card" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "identifier" integer NOT NULL);
CREATE TABLE "restaurant_account" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "active" smallint NOT NULL, "card_id" integer NOT NULL REFERENCES "restaurant_card" ("id"), "paid" smallint NOT NULL);
